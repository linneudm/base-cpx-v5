...
AddEventHandler("inventory:CreateWeapon", function(Name)
	...
	AttachEntityToEntity(Objects[WeaponName], Ped, Bone, Data.x, Data.y, Data.z, Data.RotX, Data.RotY, Data.RotZ, true,
...
local function hasWeaponColorGroup()
	for group in pairs(WEAPON_COLOR_GROUPS) do
...
RegisterCommand("cor", function(source, Message)
	if Message[1] and parseInt(Message[1]) >= 0 and Weapon ~= "" and hasWeaponColorGroup() then
...
function Creative.GiveComponent(Component)
	LocalPlayer.state.RecoilReducer = Weapon
