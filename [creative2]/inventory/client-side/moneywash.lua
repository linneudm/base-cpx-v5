...
local Config = {
	...
	["Init"] = vec4(258.53,-397.41,-4.6,42.52),
	["Washs"] = {
...
AddEventHandler("moneywash:Init",function()
	if Config["Active"] then
		TriggerEvent("Notify","Central de Empregos","Você acaba finalizar sua jornada de trabalho, esperamos que você tenha aprendido bastante hoje.","vermelho",5000)
