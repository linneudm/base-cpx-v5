		...
		if Warehouse[1] and Warehouse[1]["Passport"] == Passport then
			...
			if Keyboard then
				...
				if string.len(Password) >= 4 and string.len(Password) <= 20 then
					...
					TriggerClientEvent("Notify", source, "Atenção", "Necessário possuir entre <b>4</b> e <b>20</b> números.",
						"amarelo", 5000)
				end
			end
		end
			...
			if vRP.Request(source, "Armazém", "Gostaria de comprar o armazém por <b>$100.000</b>?") then
				...
				if Keyboard then
					...
					if string.len(Password) >= 4 and string.len(Password) <= 20 then
						...
						TriggerClientEvent("Notify", source, "Aviso", "Necessário possuir entre <b>4</b> e <b>20</b> números.",
							"amarelo", 5000)
					end
				end
			end
