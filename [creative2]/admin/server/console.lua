...
RegisterCommand("shutdown", function(source)
	if source == 0 then
		TriggerClientEvent("Notify", -1, "Terremoto",
			"Os geólogos informaram para nossa unidade governamental que foi encontrado um abalo de magnitude <b>60</b> na <b>Escala Richter</b>, encontrem abrigo até que o mesmo passe.",
			"vermelho", 60000)
...
RegisterCommand("quake", function(source)
	if source == 0 then
		TriggerClientEvent("Notify", -1, "Terromoto",
			"Os geólogos informaram para nossa unidade governamental que foi encontrado um abalo de magnitude <b>60</b> na <b>Escala Richter</b>, encontrem abrigo até que o mesmo passe.",
			"vermelho", 60000)
		GlobalState["Quake"] = true
	end
...
RegisterCommand("console", function(source, Message, History)
	if source == 0 then
		TriggerClientEvent("Notify", -1, "Prefeitura", History:sub(9), "default", 60000)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- ONLINES
