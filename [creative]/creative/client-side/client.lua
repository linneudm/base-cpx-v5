		...
		if Vehicle.Vehicle ~= nil then
			...
			if IsControlPressed(0, 244) and GetEntityHealth(ped) > 100 and IsVehicleSeatFree(Vehicle.Vehicle, -1) and not IsEntityAttachedToEntity(ped, Vehicle.Vehicle) and not (GetEntityRoll(Vehicle.Vehicle) > 75.0 or GetEntityRoll(Vehicle.Vehicle) < -75.0) then
				...
				if Vehicle.IsInFront then
					AttachEntityToEntity(ped, Vehicle.Vehicle, GetPedBoneIndex(6286), 0.0, Vehicle.Dimensions.y * -1 + 0.1,
...
Citizen.CreateThread(function()
	while true do
		...
		RemoveVehiclesFromGeneratorsInArea(366.15 - 5.0, -1453.25 - 5.0, 29.44 - 5.0, 366.15 + 5.0, -1453.25 + 5.0,
			29.44 + 5.0)
		...
		RemoveVehiclesFromGeneratorsInArea(459.25 - 10.0, -604.23 - 10.0, 28.5 - 10.0, 459.25 + 10.0, -604.23 + 10.0,
			28.5 + 10.0)
		RemoveVehiclesFromGeneratorsInArea(-449.8 - 10.0, 5998.04 - 10.0, 31.35 - 10.0, -449.8 + 10.0, 5998.04 + 10.0,
			31.35 + 10.0)
		RemoveVehiclesFromGeneratorsInArea(-476.6 - 10.0, 6030.53 - 10.0, 31.34 - 10.0, -476.6 + 10.0, 6030.53 + 10.0,
			31.34 + 10.0)
		RemoveVehiclesFromGeneratorsInArea(407.85 - 10.0, -996.92 - 10.0, 29.27 - 10.0, 407.85 + 10.0, -996.92 + 10.0,
			29.27 + 10.0)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
