...
function createMiddle(ped, x, y, z)
	...
	homeObjects[2] = CreateObject(GetHashKey("V_16_DT"), x - 1.21854400, y - 1.04389600, z + 1.39068600, false, false,
		false)
	homeObjects[3] = CreateObject(GetHashKey("V_16_mpmidapart01"), x + 0.52447510, y - 5.04953700, z + 1.32, false, false,
		false)
	homeObjects[4] = CreateObject(GetHashKey("V_16_mpmidapart09"), x + 0.82202150, y + 2.29612000, z + 1.88, false, false,
		false)
	homeObjects[5] = CreateObject(GetHashKey("V_16_mpmidapart07"), x - 1.91445900, y - 6.61911300, z + 1.45, false, false,
		false)
	homeObjects[6] = CreateObject(GetHashKey("V_16_mpmidapart03"), x - 4.82565300, y - 6.86803900, z + 1.14, false, false,
		false)
	homeObjects[7] = CreateObject(GetHashKey("V_16_midapartdeta"), x + 2.28558400, y - 1.94082100, z + 1.288628, false,
		false, false)
	homeObjects[8] = CreateObject(GetHashKey("V_16_treeglow"), x - 1.37408500, y - 0.95420070, z + 1.135, false, false,
		false)
	homeObjects[9] = CreateObject(GetHashKey("V_16_midapt_curts"), x - 1.96423300, y - 0.95958710, z + 1.280, false, false,
		false)
	homeObjects[10] = CreateObject(GetHashKey("V_16_mpmidapart13"), x - 4.65580700, y - 6.61684000, z + 1.259, false, false,
		false)
	homeObjects[11] = CreateObject(GetHashKey("V_16_midapt_cabinet"), x - 1.16177400, y - 0.97333810, z + 1.27, false,
		false, false)
	homeObjects[12] = CreateObject(GetHashKey("V_16_midapt_deca"), x + 2.311386000, y - 2.05385900, z + 1.297, false, false,
		false)
	homeObjects[13] = CreateObject(GetHashKey("V_16_mid_hall_mesh_delta"), x + 3.69693000, y - 5.80020100, z + 1.293, false,
		false, false)
	homeObjects[14] = CreateObject(GetHashKey("V_16_mid_bed_delta"), x + 7.95187400, y + 1.04246500, z + 1.28402300, false,
		false, false)
	homeObjects[15] = CreateObject(GetHashKey("apa_mp_h_bed_double_08"), x + 5.56576900, y + 1.15651200, z + 1.36589100,
		false, false, false)
	homeObjects[17] = CreateObject(GetHashKey("V_16_mid_bath_mesh_delta"), x + 4.45460500, y + 3.21322800, z + 1.21116100,
		false, false, false)
	homeObjects[18] = CreateObject(GetHashKey("V_16_mid_bath_mesh_mirror"), x + 3.57740800, y + 3.25032000, z + 1.48871300,
		false, false, false)

	homeObjects[19] = CreateObject(GetHashKey("Prop_CS_Beer_Bot_01"), x + 1.73134600, y - 4.88520200, z + 1.91083000, false,
		false, false)
	homeObjects[20] = CreateObject(GetHashKey("v_res_mp_sofa"), x - 1.48765600, y + 1.68100600, z + 1.21640500, false,
		false, false)
	homeObjects[21] = CreateObject(GetHashKey("v_res_mp_stripchair"), x - 4.44770800, y - 1.78048800, z + 1.21640500, false,
		false, false)
	homeObjects[23] = CreateObject(GetHashKey("Prop_Plant_Int_04a"), x + 2.78941300, y - 4.39133900, z + 2.12746400, false,
		false, false)
	homeObjects[24] = CreateObject(GetHashKey("v_res_d_lampa"), x - 3.61473100, y - 6.61465100, z + 2.08382800, false,
		false, false)
	homeObjects[25] = CreateObject(GetHashKey("v_res_fridgemodsml"), x + 1.90339700, y - 3.80026800, z + 1.29917900, false,
		false, false)
	homeObjects[26] = CreateObject(GetHashKey("prop_micro_01"), x + 2.03442400, y - 4.61585100, z + 2.30395600, false,
		false, false)
	homeObjects[27] = CreateObject(GetHashKey("V_Res_Tre_SideBoard"), x + 2.84053000, y - 4.30947100, z + 1.24577300, false,
		false, false)
	homeObjects[28] = CreateObject(GetHashKey("V_Res_Tre_BedSideTable"), x - 3.50363200, y - 6.55289400, z + 1.30625800,
		false, false, false)
	homeObjects[29] = CreateObject(GetHashKey("v_res_d_lampa"), x + 2.69674700, y - 3.83123500, z + 2.09373700, false,
		false, false)
	homeObjects[30] = CreateObject(GetHashKey("v_res_tre_tree"), x - 4.96064800, y - 6.09898500, z + 1.31631400, false,
		false, false)
	homeObjects[31] = CreateObject(GetHashKey("V_Res_M_DineTble_replace"), x - 3.50712600, y - 4.13621600, z + 1.29625800,
		false, false, false)
	homeObjects[32] = CreateObject(GetHashKey("Prop_TV_Flat_01"), x - 5.53120400, y + 0.76299670, z + 2.17236000, false,
		false, false)
	homeObjects[33] = CreateObject(GetHashKey("v_res_tre_plant"), x - 5.14112800, y - 2.78951000, z + 1.25950800, false,
		false, false)
	homeObjects[34] = CreateObject(GetHashKey("v_res_m_dinechair"), x - 3.04652400, y - 4.95971200, z + 1.19625800, false,
		false, false)
	homeObjects[35] = CreateObject(GetHashKey("v_res_m_lampstand"), x + 1.26588400, y + 3.68883900, z + 1.30556700, false,
		false, false)
	homeObjects[36] = CreateObject(GetHashKey("V_Res_M_Stool_REPLACED"), x - 3.23216300, y + 2.06159000, z + 1.20556700,
		false, false, false)
	homeObjects[37] = CreateObject(GetHashKey("v_res_m_dinechair"), x - 2.82237200, y - 3.59831300, z + 1.25950800, false,
		false, false)
	homeObjects[38] = CreateObject(GetHashKey("v_res_m_dinechair"), x - 4.14955100, y - 4.71316600, z + 1.19625800, false,
		false, false)
	homeObjects[39] = CreateObject(GetHashKey("v_res_m_dinechair"), x - 3.80622900, y - 3.37648300, z + 1.19625800, false,
		false, false)

	homeObjects[40] = CreateObject(GetHashKey("v_res_fa_plant01"), x + 2.97859200, y + 2.55307400, z + 1.85796300, false,
		false, false)
	homeObjects[41] = CreateObject(GetHashKey("v_res_tre_storageunit"), x + 8.47819500, y - 2.50979300, z + 1.19712300,
		false, false, false)
	homeObjects[42] = CreateObject(GetHashKey("v_res_tre_storagebox"), x + 9.75982700, y - 1.35874100, z + 1.29625800,
		false, false, false)
	homeObjects[43] = CreateObject(GetHashKey("v_res_tre_basketmess"), x + 8.70730600, y - 2.55503600, z + 1.94059590,
		false, false, false)
	homeObjects[44] = CreateObject(GetHashKey("v_res_m_lampstand"), x + 9.54306000, y - 2.50427700, z + 1.30556700, false,
		false, false)
	homeObjects[45] = CreateObject(GetHashKey("Prop_Plant_Int_03a"), x + 9.87521400, y + 3.90917400, z + 1.20829700, false,
		false, false)

	homeObjects[46] = CreateObject(GetHashKey("v_res_tre_washbasket"), x + 9.39091500, y + 4.49676300, z + 1.19625800,
		false, false, false)
	homeObjects[47] = CreateObject(GetHashKey("V_Res_Tre_Wardrobe"), x + 8.46626300, y + 4.53223600, z + 1.19425800, false,
		false, false)
	homeObjects[48] = CreateObject(GetHashKey("v_res_tre_flatbasket"), x + 8.51593000, y + 4.55647300, z + 3.46737300,
		false, false, false)
	homeObjects[49] = CreateObject(GetHashKey("v_res_tre_basketmess"), x + 7.57797200, y + 4.55198800, z + 3.46737300,
		false, false, false)
	homeObjects[50] = CreateObject(GetHashKey("v_res_tre_flatbasket"), x + 7.12286400, y + 4.54689200, z + 3.46737300,
		false, false, false)
	homeObjects[51] = CreateObject(GetHashKey("V_Res_Tre_Wardrobe"), x + 7.24382000, y + 4.53423500, z + 1.19625800, false,
		false, false)
	homeObjects[52] = CreateObject(GetHashKey("v_res_tre_flatbasket"), x + 8.03364600, y + 4.54835500, z + 3.46737300,
		false, false, false)

	homeObjects[53] = CreateObject(GetHashKey("v_serv_switch_2"), x + 6.28086900, y - 0.68169880, z + 2.30326000, false,
		false, false)

	homeObjects[54] = CreateObject(GetHashKey("V_Res_Tre_BedSideTable"), x + 5.84416200, y + 2.57377400, z + 1.22089100,
		false, false, false)
	homeObjects[55] = CreateObject(GetHashKey("v_res_d_lampa"), x + 5.84912100, y + 2.58001100, z + 1.95311890, false,
		false, false)
	homeObjects[56] = CreateObject(GetHashKey("v_res_mlaundry"), x + 5.77729800, y + 4.60211400, z + 1.19674400, false,
		false, false)

	homeObjects[57] = CreateObject(GetHashKey("Prop_ashtray_01"), x - 1.24716200, y + 1.07820500, z + 1.89089300, false,
		false, false)

	homeObjects[58] = CreateObject(GetHashKey("v_res_fa_candle03"), x - 2.89289900, y - 4.35329700, z + 2.02881310, false,
		false, false)
	homeObjects[59] = CreateObject(GetHashKey("v_res_fa_candle02"), x - 3.99865700, y - 4.06048500, z + 2.02530190, false,
		false, false)
	homeObjects[60] = CreateObject(GetHashKey("v_res_fa_candle01"), x - 3.37733400, y - 3.66639800, z + 2.02526200, false,
		false, false)
	homeObjects[61] = CreateObject(GetHashKey("v_res_m_woodbowl"), x - 3.50787400, y - 4.11983000, z + 2.02589900, false,
		false, false)
	homeObjects[62] = CreateObject(GetHashKey("V_Res_TabloidsA"), x - 0.80513000, y + 0.51389600, z + 1.18418800, false,
		false, false)

	homeObjects[64] = CreateObject(GetHashKey("v_res_tre_fruitbowl"), x + 2.77764900, y - 4.138297000, z + 2.10340100,
		false, false, false)
	homeObjects[65] = CreateObject(GetHashKey("v_res_sculpt_dec"), x + 3.03932200, y + 1.62726400, z + 3.58363900, false,
		false, false)
	homeObjects[66] = CreateObject(GetHashKey("v_res_jewelbox"), x + 3.04164100, y + 0.31671810, z + 3.58363900, false,
		false, false)

	homeObjects[67] = CreateObject(GetHashKey("v_res_tre_basketmess"), x - 1.64906300, y + 1.62675900, z + 1.39038500,
		false, false, false)
	homeObjects[68] = CreateObject(GetHashKey("v_res_tre_flatbasket"), x - 1.63938900, y + 0.91133310, z + 1.39038500,
		false, false, false)

	homeObjects[69] = CreateObject(GetHashKey("v_res_tre_flatbasket"), x - 1.19923400, y + 1.69598600, z + 1.39038500,
		false, false, false)
	homeObjects[70] = CreateObject(GetHashKey("v_res_tre_basketmess"), x - 1.18293800, y + 0.91436380, z + 1.39038500,
		false, false, false)
	homeObjects[71] = CreateObject(GetHashKey("v_res_r_sugarbowl"), x - 0.26029210, y - 6.66716800, z + 3.77324900, false,
		false, false)
	homeObjects[72] = CreateObject(GetHashKey("Prop_Breadbin_01"), x + 2.09788500, y - 6.57634000, z + 2.24041900, false,
		false, false)
	homeObjects[73] = CreateObject(GetHashKey("v_res_mknifeblock"), x + 1.82084700, y - 6.58438500, z + 2.27399500, false,
		false, false)

	homeObjects[74] = CreateObject(GetHashKey("prop_toaster_01"), x - 1.05790700, y - 6.59017400, z + 2.26793200, false,
		false, false)
	homeObjects[76] = CreateObject(GetHashKey("Prop_Plant_Int_03a"), x + 2.55015600, y + 4.60183900, z + 1.20829700, false,
		false, false)

	homeObjects[78] = CreateObject(GetHashKey("v_res_tissues"), x + 7.95889300, y - 2.54847100, z + 1.94013400, false,
		false, false)
	homeObjects[79] = CreateObject(GetHashKey("v_club_vuhairdryer"), x + 8.12616000, y - 2.50562000, z + 1.96009390, false,
		false, false)
	homeObjects[80] = CreateObject(GetHashKey("prop_watercooler"), x - 0.605, y - 3.10562000, z + 1.36009390, false, false,
		false)
					...
					if IsControlJustPressed(1, 38) then
						...
						elseif v[4] == "vault" then
							if vSERVER.checkIntPermissions(tostring(houseOpen)) then
								...
								TriggerEvent("inventory:openMochila", { house = houseOpen })
