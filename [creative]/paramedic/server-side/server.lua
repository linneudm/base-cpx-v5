...
local preset = {
	...
	["2"] = {
		["mp_m_freemode_01"] = {
			...
			["tshirt"] = { item = 15, texture = 0 },
			["torso"] = { item = 209, texture = 9 },
			["accessory"] = { item = 180, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
		...
		["mp_f_freemode_01"] = {
			...
			["shoes"] = { item = 16, texture = 0 },
			["tshirt"] = { item = 15, texture = 0 },
			["torso"] = { item = 249, texture = 9 },
			["accessory"] = { item = 0, texture = 0 },
			["watch"] = { item = -1, texture = 0 },
			["arms"] = { item = 9, texture = 3 },
			["glass"] = { item = 0, texture = 0 },
			["ear"] = { item = -1, texture = 0 }
		}
	}
