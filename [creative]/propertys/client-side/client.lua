						...
						if distance <= 1.25 then
							...
							if IsControlJustPressed(1,38) and GetGameTimer() >= homes["pressButton"] and MumbleIsConnected() then
								if vSERVER.checkOwner(k) then
									...
									exports["dynamic"]:AddButton("Valor","Custo de <yellow>"..parseFormat(config.AmberPrice).."</yellow> gemas.","","","Amber",false)
									...
									exports["dynamic"]:AddButton("Valor","Custo de <yellow>"..parseFormat(config.AmethystPrice).."</yellow> gemas.","","","Amethyst",false)
