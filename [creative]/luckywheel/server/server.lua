...
AddEventHandler("luckywheel:Payment", function()
    ...
    if user_id and wheelPayments[user_id] then
        local payment = wheelPayments[user_id]

        if payment == 1 then
            vRP.giveInventoryItem(user_id, "dollars", 2500, true)
        elseif payment == 2 then
            vRP.giveInventoryItem(user_id, "dollars", 1500, true)
        elseif payment == 3 then
            vRP.giveInventoryItem(user_id, "chips", 1500, true)
        elseif payment == 4 then
            vRP.giveInventoryItem(user_id, "chips", 1000, true)
        elseif payment == 5 then
            local identity = vRP.userIdentity(user_id)
            wheelBonus[identity["steam"]] = true
        elseif payment == 6 then
            vRP.giveInventoryItem(user_id, "dollars", 5000, true)
        elseif payment == 7 then
            vRP.giveInventoryItem(user_id, "dollars", 2000, true)
        elseif payment == 8 then
            vRP.giveInventoryItem(user_id, "chips", 1250, true)
        elseif payment == 9 then
            vRP.giveInventoryItem(user_id, "dollars", 750, true)
        elseif payment == 10 then
            local identity = vRP.userIdentity(user_id)
            vRP.execute("accounts/infosUpdategems", { steam = identity["steam"], gems = 10 })
        elseif payment == 11 then
            vRP.giveInventoryItem(user_id, "dollars", 2250, true)
        elseif payment == 12 then
            vRP.giveInventoryItem(user_id, "chips", 1750, true)
        elseif payment == 13 then
            vRP.giveInventoryItem(user_id, "dollars", 1250, true)
        elseif payment == 14 then
