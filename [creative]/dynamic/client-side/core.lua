...
local function canOpenDynamicMenu()
	return not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not menuOpen and
			MumbleIsConnected() and LocalPlayer["state"]["Route"] < 900000
end

local function beginDynamicMenu()
	if not canOpenDynamicMenu() then
		return false
	end
...
local function cancelDynamicMenu()
	menuOpen = false
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- ANIMAL
...
RegisterCommand("globalFunctions", function(source, args, rawCommand)
	if beginDynamicMenu() then
		...
		if GetEntityHealth(Ped) > 100 then
			...
			exports["dynamic"]:AddButton("Chapéu", "Colocar/Retirar o chapéu.", "player:outfitFunctions", "Hat", "clothes",
				true)
			exports["dynamic"]:AddButton("Máscara", "Colocar/Retirar a máscara.", "player:outfitFunctions", "Mask", "clothes",
				true)
			exports["dynamic"]:AddButton("Óculos", "Colocar/Retirar o óculos.", "player:outfitFunctions", "Glasses", "clothes",
				true)
			exports["dynamic"]:AddButton("Jaqueta", "Colocar/Retirar a jaqueta.", "player:outfitFunctions", "Jacket", "clothes",
				true)
			exports["dynamic"]:AddButton("Camiseta", "Colocar/Retirar a camiseta.", "player:outfitFunctions", "Shirt",
				"clothes", true)
			exports["dynamic"]:AddButton("Luvas", "Colocar/Retirar as luvas.", "player:outfitFunctions", "Arms", "clothes",
				true)

			exports["dynamic"]:AddButton("Aplicar", "Vestir as roupas salvas.", "player:outfitFunctions", "aplicar", "clothes",
				true)
			exports["dynamic"]:AddButton("Salvar", "Guardar as roupas do corpo.", "player:outfitFunctions", "salvar", "clothes",
				true)
			exports["dynamic"]:AddButton("Remover", "Remover as roupas salvas.", "player:outfitFunctions", "remover", "clothes",
				true)

			exports["dynamic"]:AddButton("Aplicar", "Vestir as roupas salvas.", "player:outfitFunctions", "preaplicar",
				"premiumfit", true)
			exports["dynamic"]:AddButton("Salvar", "Guardar as roupas do corpo.", "player:outfitFunctions", "presalvar",
				"premiumfit", true)

			if animalHash ~= nil then
				exports["dynamic"]:AddButton("Seguir", "Seguir o proprietário.", "dynamic:animalFunctions", "seguir", "animal",
					false)
				exports["dynamic"]:AddButton("Colocar no Veículo", "Colocar o animal no veículo.", "dynamic:animalFunctions",
					"colocar", "animal", false)
				exports["dynamic"]:AddButton("Remover do Veículo", "Remover o animal no veículo.", "dynamic:animalFunctions",
					"remover", "animal", false)
			end
			...
			if not IsPedInAnyVehicle(Ped) then
				exports["dynamic"]:AddButton("Rebocar", "Colocar veículo na prancha do reboque.", "towdriver:invokeTow", "",
					"others", false)
				...
				exports["dynamic"]:AddButton("Banco Dianteiro Esquerdo", "Sentar no banco do motorista.", "player:seatPlayer",
					"0", "vehicle", false)
				exports["dynamic"]:AddButton("Banco Dianteiro Direito", "Sentar no banco do passageiro.", "player:seatPlayer",
					"1", "vehicle", false)
				exports["dynamic"]:AddButton("Banco Traseiro Esquerdo", "Sentar no banco do passageiro.", "player:seatPlayer",
					"2", "vehicle", false)
				exports["dynamic"]:AddButton("Banco Traseiro Direito", "Sentar no banco do passageiro.", "player:seatPlayer", "3",
					"vehicle", false)
				exports["dynamic"]:AddButton("Levantar Vidros", "Levantar todos os vidros.", "player:winsFunctions", "1",
					"vehicle", true)
				exports["dynamic"]:AddButton("Abaixar Vidros", "Abaixar todos os vidros.", "player:winsFunctions", "0", "vehicle",
					true)
			...
			for Name, Exp in pairs(Experience) do
				exports["dynamic"]:AddButton(Name,
					"Você possuí <yellow>" .. Exp .. " pontos</yellow> na classe <yellow>" .. ClassCategory(Exp) .. "</yellow>.",
					"", "", "Experience", false)
			end
...
RegisterCommand("emergencyFunctions", function(source, args, rawCommand)
	if LocalPlayer["state"]["Police"] or LocalPlayer["state"]["Paramedic"] or LocalPlayer["state"]["Uwucafe"] then
		if beginDynamicMenu() then
			...
			if GetEntityHealth(Ped) > 100 then
				if not IsPedInAnyVehicle(Ped) then
					exports["dynamic"]:AddButton("Carregar", "Carregar a pessoa mais próxima.", "player:carryPlayer", "", "player",
						true)
				...
				if LocalPlayer["state"]["Police"] then
					exports["dynamic"]:AddButton("Remover Chapéu", "Remover da pessoa mais próxima.", "skinshop:removeProps", "Hat",
						"player", true)
					exports["dynamic"]:AddButton("Remover Máscara", "Remover da pessoa mais próxima.", "skinshop:removeProps",
						"Mask", "player", true)
					exports["dynamic"]:AddButton("Remover Óculos", "Remover da pessoa mais próxima.", "skinshop:removeProps",
						"Glasses", "player", true)

					exports["dynamic"]:AddButton("Recruta", "Fardamento de Recruta.", "player:presetFunctions", "1", "prePolice",
						true)
					exports["dynamic"]:AddButton("Oficial", "Fardamento de oficial.", "player:presetFunctions", "2", "prePolice",
						true)
					exports["dynamic"]:AddButton("COMANF", "Fardamento de COMANF.", "player:presetFunctions", "3", "prePolice",
						true)
					...
					exports["dynamic"]:AddButton("DIP - Delegado", "Fardamento de DIP.", "player:presetFunctions", "7", "prePolice",
						true)
					...
					exports["dynamic"]:AddButton("PANELA", "Fardamento da Panela.", "player:presetFunctions", "15", "prePolice",
						true)
					exports["dynamic"]:AddButton("Comando", "Fardamento do Comando.", "player:presetFunctions", "11", "prePolice",
						true)
					...
					exports["dynamic"]:AddButton("Computador", "Computador de bordo policial.", "police:openSystem", "", false,
						false)
				elseif LocalPlayer["state"]["Paramedic"] then
					exports["dynamic"]:AddButton("Uniforme de Doutor", "Fardamento de doutor.", "player:presetFunctions", "12",
						"preMedic", true)
				...
				if vSERVER.checkPermissions("masterPolice") then
					exports["dynamic"]:AddButton("Adicionar contingente", "Adicione uma nova pessoa ao grupo.", "dynamic:setGroup",
						"waitPolice", false, true)
					exports["dynamic"]:AddButton("Remover contingente", "Remover uma pessoa do seu grupo.", "dynamic:remGroup",
						"waitPolice", false, true)
				elseif vSERVER.checkPermissions("masterParamedic") then
					exports["dynamic"]:AddButton("Adicionar contingente", "Adicione uma nova pessoa ao grupo.", "dynamic:setGroup",
						"waitParamedic", false, true)
					exports["dynamic"]:AddButton("Remover contingente", "Remover uma pessoa do seu grupo.", "dynamic:remGroup",
						"waitParamedic", false, true)
				end
...
RegisterCommand("foodsFunctions", function(source, args, rawCommand)
	if LocalPlayer["state"]["Uwucafe"] then
		if beginDynamicMenu() then
			if LocalPlayer["state"]["Uwucafe"] then
				exports["dynamic"]:AddButton("Uniform's", "Fardamento de Atendente.", "player:presetFunctions", "14", "prePolice",
					true)
