...
function L9_1(A0_2, A1_2, A2_2)
  ...
  L4_2 = "SELECT link FROM phone_photos WHERE phone_number = ? AND id IN (?)"
  ...
  for L7_2 = L4_2, L5_2, L6_2 do
    ...
    L10_2 = "lb-phone:deletedFromGallery"
  ...
  L5_2 = "DELETE FROM phone_photos WHERE phone_number = ? AND id IN (?)"
