...
L3_1.like = "BACKEND.TIKTOK.LIKE"

L3_1.save = "BACKEND.TIKTOK.SAVE"

L3_1.comment = "BACKEND.TIKTOK.COMMENT"

L3_1.follow = "BACKEND.TIKTOK.FOLLOW"

L3_1.like_comment = "BACKEND.TIKTOK.LIKED_COMMENT"

L3_1.reply = "BACKEND.TIKTOK.REPLIED_COMMENT"

L3_1.message = "BACKEND.TIKTOK.DM"
...
function L5_1(A0_2)
  ...
  L2_2 = "DELETE FROM phone_tiktok_accounts WHERE username = ?"
  ...
  L3_2 = "DELETE FROM phone_logged_in_accounts WHERE username = ? AND app = 'TikTok'"
  ...
  if not L3_2 then
    ...
    if L4_2 then
      ...
      if not L4_2 then
        ...
        L5_2 = "tiktok:uploadVideo - postTrendy check failed"
