...
L4_1.like = "BACKEND.TWITTER.LIKE"

L4_1.retweet = "BACKEND.TWITTER.RETWEET"

L4_1.reply = "BACKEND.TWITTER.REPLY"

L4_1.follow = "BACKEND.TWITTER.FOLLOW"

L4_1.tweet = "BACKEND.TWITTER.TWEET"
  ...
  if L7_2 then
    ...
    if L7_2 then
      ...
      for L11_2 = L8_2, L9_2, L10_2 do
        ...
        L13_2 = "INSERT INTO phone_twitter_follows (followed, follower, notifications) VALUES (?, ?, 1)"
...
function L6_1(A0_2)
  ...
  L2_2 = "DELETE FROM phone_twitter_accounts WHERE username = ?"
  ...
  L6_2 = "BACKEND.MISC.DELETED_NOTIFICATION.TITLE"
  ...
  L6_2 = "BACKEND.MISC.DELETED_NOTIFICATION.DESCRIPTION"
  ...
  L3_2 = "DELETE FROM phone_logged_in_accounts WHERE username = ? AND app = 'Twitter'"
...
function L12_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2)
  ...
  if not L7_2 then
    ...
    L8_2 = "birdy:sendPost - postBirdy check failed"
...
function L13_1(A0_2, A1_2, A2_2, A3_2)
  ...
  if L6_2 then
    ...
    if A3_2 then
      ...
      function L10_2(A0_3)
        ...
        L6_3 = "BACKEND.TWITTER.NEW_FOLLOW_REQUEST"
  ...
  L7_2 = "INSERT IGNORE INTO phone_twitter_follows (followed, follower, notifications) VALUES (@username, @loggedInAs, 1)"
...
function L13_1(A0_2, A1_2, A2_2, A3_2)
  ...
  L8_2 = "INSERT IGNORE INTO phone_twitter_follows (follower, followed, notifications) VALUES (@username, @loggedInAs, 1)"
  ...
  L12_2 = "BACKEND.TWITTER.FOLLOW_REQUEST_ACCEPTED_DESCRIPTION"
...
function L13_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2)
  ...
  for L10_2 = L7_2, L8_2, L9_2 do
    ...
    if L11_2 then
      ...
      L13_2 = "phone:twitter:newMessage"
      ...
      L15_2.recipient = A3_2

      L15_2.content = A4_2

      L15_2.attachments = A5_2
  ...
  L12_2 = L7_2.profile_picture

  L11_2.avatar = L12_2

  L11_2.showAvatar = true
