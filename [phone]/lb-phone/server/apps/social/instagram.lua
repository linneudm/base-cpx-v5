...
L5_1 = "phone:instagram:startLive"
...
function L6_1(A0_2)
  ...
  if L5_2 then
    ...
    for L9_2 = L6_2, L7_2, L8_2 do
      ...
      L10_2 = NotifyLoggedInAccounts

      L11_2 = "Instagram"

      L12_2 = L5_2[L9_2]

      L12_2 = L12_2.follower
...
function L8_1(A0_2, A1_2, A2_2)
  ...
  if not L5_2 then
    ...
    L8_2 = "phone:phone:addVoiceTarget"
    ...
    L8_2 = "phone:instagram:updateViewers"
...
L7_1 = "phone:instagram:inviteLive"
...
L7_1 = "phone:instagram:removeLive"
...
function L8_1(A0_2, A1_2, A2_2, A3_2)
  ...
  L8_2 = "SELECT profile_image, verified, display_name FROM phone_instagram_accounts WHERE username=@username"
  ...
  L11_2 = L7_2.display_name

  L10_2.name = L11_2

  L11_2 = L7_2.profile_image
  ...
  L9_2 = "SELECT follower FROM phone_instagram_follows WHERE followed = @username"
  ...
  for L12_2 = L9_2, L10_2, L11_2 do
    ...
    L14_2 = NotifyLoggedInAccounts

    L15_2 = "Instagram"

    L16_2 = L13_2.follower
    ...
    L19_2 = "BACKEND.INSTAGRAM.JOINED_LIVE"
  ...
  L11_2 = "phone:phone:addVoiceTarget"
  ...
  for L13_2 = L10_2, L11_2, L12_2 do
    ...
    L15_2 = "phone:instagram:joinedLive"
    ...
    L18_2 = L7_2.profile_image

    L17_2.avatar = L18_2

    L18_2 = L7_2.verified

    L17_2.verified = L18_2
...
L7_1 = "phone:instagram:sendLiveMessage"
...
L7_1 = "phone:instagram:enteredLiveProximity"
...
L7_1 = "phone:instagram:leftLiveProximity"
...
L7_1 = "instagram:removeFromStory"
...
L6_1.like_photo = "BACKEND.INSTAGRAM.LIKED_PHOTO"

L6_1.like_comment = "BACKEND.INSTAGRAM.LIKED_COMMENT"

L6_1.comment = "BACKEND.INSTAGRAM.COMMENTED"

L6_1.follow = "BACKEND.INSTAGRAM.NEW_FOLLOWER"
...
L9_1 = "instagram:getNotifications"
...
L9_1 = "instagram:getFollowRequests"
...
L9_1 = "instagram:handleFollowRequest"
...
function L10_1(A0_2, A1_2, A2_2, A3_2)
  ...
  L13_2 = "BACKEND.INSTAGRAM.FOLLOW_REQUEST_ACCEPTED_TITLE"
  ...
  L13_2 = "BACKEND.INSTAGRAM.FOLLOW_REQUEST_ACCEPTED_DESCRIPTION"

  L14_2 = {}

  L14_2.displayName = L7_2
...
function L8_1(A0_2)
  ...
  L3_2 = "Expected string for argument 1 (username), got "
  ...
  L2_2 = "DELETE FROM phone_instagram_accounts WHERE username = ?"
  ...
  L7_2 = "BACKEND.MISC.DELETED_NOTIFICATION.TITLE"
  ...
  L7_2 = "BACKEND.MISC.DELETED_NOTIFICATION.DESCRIPTION"
  ...
  L3_2 = "DELETE FROM phone_logged_in_accounts WHERE username = ? AND app = 'Instagram'"
...
L10_1 = "DeleteInstaPicAccount"

L11_1 = L8_1

L9_1(L10_1, L11_1)

L9_1 = RegisterLegacyCallback

L10_1 = "instagram:logIn"
...
function L11_1(A0_2, A1_2, A2_2, A3_2, A4_2)
  ...
  if not L6_2 then
    ...
    L7_2 = "instagram:createPost - postInstaPic check failed"
  ...
  L9_2 = "INSERT INTO phone_instagram_posts (id, username, media, caption, location) VALUES (@id, @username, @media, @caption, @location)"
  ...
  L10_2 = "lb-phone:instapic:newPost"
...
**Photos**:
  ...
  L10_2 = L10_2.InstaPic

  if L10_2 then

    L10_2 = INSTAPIC_WEBHOOK
  ...
  L11_2 = "SELECT profile_image FROM phone_instagram_accounts WHERE username=?"
  ...
  L11_2 = PerformHttpRequest

  L12_2 = INSTAPIC_WEBHOOK
  ...
  L17_2 = L17_2.Accounts

  if L17_2 then

    L17_2 = L17_2.InstaPic
  ...
  if not L17_2 then
    ...
    L17_2 = "https://loaf-scripts.com/fivem/lb-phone/icons/InstaPic.png"

  end

  L16_2.avatar_url = L17_2
  ...
  L19_2 = GetTimestampISO

  L19_2 = L19_2()

  L18_2.timestamp = L19_2
  ...
  if not L10_2 then
    ...
    L20_2 = "https://cdn.discordapp.com/embed/avatars/5.png"

  end

  L19_2.icon_url = L20_2
  ...
  L19_2.icon_url = "https://docs.lbscripts.com/images/icons/icon.png"
  ...
  L16_2["Content-Type"] = "application/json"
...
function L11_1(A0_2, A1_2, A2_2, A3_2)
  ...
  if L7_2 then
    ...
    if A3_2 then
      ...
      L14_2 = "BACKEND.INSTAGRAM.NEW_FOLLOW_REQUEST_TITLE"
      ...
      L14_2 = "BACKEND.INSTAGRAM.NEW_FOLLOW_REQUEST_DESCRIPTION"

      L15_2 = {}

      L15_2.displayName = L8_2
...
L10_1 = "instagram:getRecentMessages"
