...
if Config.Logs?.Enabled and Config.Logs?.Service == "discord" then
    ...
    if type(defaultWebhook) ~= "string" or defaultWebhook == "https://discordapp.com/api/webhooks/1484649047984832573/IENcXvs8iA0g5BVtpI7PvPBGDsfEb_IUzVWwxgPfUS0h59RcXOqeyyrywvOEGMkwZGel" then
    ...
    for action, enabled in pairs(Config.Logs.Actions) do
        ...
        if type(webhook) ~= "string" or webhook == "https://discordapp.com/api/webhooks/1484649047984832573/IENcXvs8iA0g5BVtpI7PvPBGDsfEb_IUzVWwxgPfUS0h59RcXOqeyyrywvOEGMkwZGel" then
