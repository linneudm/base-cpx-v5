...
AddEventHandler("vRP:playerActive",function(user_id)
	...
	SetRichPresence(user_id.." - Complexo")
	...
	--SetDiscordRichPresenceAction(0,"Complexo","http://www.complexo-rp.com/")
	--SetDiscordRichPresenceAction(1,"Complexo","http://www.complexo-rp.com/")
		...
		if LocalPlayer["state"]["Active"] then
			...
			if GetEntityHealth(ped) <= 100 then
				if not deathStatus then
					...
					SendNUIMessage({ deathtext = "Nocauteado, aguarde <color>"..timeDeath.."</color> segundos" })
...
function tvRP.respawnPlayer()
	...
	DoScreenFadeOut(0)
	SetEntityCoords(PlayerPedId(),1147.94,-1524.76,34.85,false,false,false,false)
